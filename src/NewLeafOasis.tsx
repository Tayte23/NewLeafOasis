...
function HeaderNav(): JSX.Element {
  ...
  const navLink = (id: string) => cn("text-white/90 hover:text-white font-semibold", active === id && "text-white font-extrabold underline decoration-2 underline-offset-4");
      ...
      <div ref={topBarRef} className="fixed top-0 left-0 right-0 z-40 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="relative h-[64px] w-[64px] sm:h-[72px] sm:w-[72px] md:h-[80px] md:w-[80px] shrink-0">
...
function Hero() {
  return (
    <section id="home" aria-labelledby="hero-title" className="bg-gradient-to-br from-emerald-50/60 to-white scroll-mt-36 md:scroll-mt-44">
